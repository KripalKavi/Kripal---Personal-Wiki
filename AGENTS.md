...
└── .Codex/commands/      # Ingest, Query, Lint skills
```
...
- **Actionable practices**: When a source includes concrete exercises, readiness checks, operating rituals, prompts, metrics, or "how to practice" steps, preserve them in the relevant section instead of only summarizing the idea. Future queries should be able to recover the exact practical steps.

## Operations

See `.Codex/commands/` for the three wiki skills:
